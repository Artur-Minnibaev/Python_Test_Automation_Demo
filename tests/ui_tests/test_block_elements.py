...
class TestElements:
    ...
    class TestTextBox:
        ...
        def test_text_box(self, chrome_browser):
            # Test-case compares the data between input data and output data
            text_box_page = TextBoxPage(chrome_browser)
    ...
    class TestCheckBox:
        ...
        def test_dropdown_list_using_toggle_dropdown_button(self, chrome_browser):
            # Test of comparison input data and output data results using toggle dropdown list
            checkbox_page = CheckBoxPage(chrome_browser)
        ...
        @allure.title('Test of comparison input data and output data results using toggle dropdown list')
        def test_dropdown_list_using_expand_all_button(self, chrome_browser):
            # Test of comparison input data and output data results using toggle dropdown list
        ...
        def test_of_selected_randomly_elements(self, chrome_browser):
        ...
        def test_of_selected_elements_by_title(self, chrome_browser):
        ...
        def test_of_closing_dropdown_list_saving_output_data(self, chrome_browser):
    ...
    class TestRadioButton:
        ...
        def test_radio_button(self, chrome_browser):
            # Test of selection options on the page "Radio Button"
            radio_button_page = RadioButtonPage(chrome_browser)
    ...
    class TestWebTable:
        ...
        def test_add_person(self, chrome_browser):
            # Test of adding a person by clicking the "Submit" button
            web_table_page = WebTablePage(chrome_browser)
        ...
        def test_closing_pop_up(self, chrome_browser):
        ...
        def test_searching_person_in_the_table(self, chrome_browser):
        ...
        def test_update_information_of_person(self, chrome_browser):
        ...
        def test_of_deleting_person(self, chrome_browser):
        ...
        def test_web_table_change_count_row(self, chrome_browser):
    ...
    class TestButtonsPage:
        ...
        def test_double_click(self, chrome_browser):
            web_buttons_page = WebButtonsPage(chrome_browser)
        ...
        def test_right_click(self, chrome_browser):
            web_buttons_page = WebButtonsPage(chrome_browser)
            web_buttons_page.open_page_buttons()
        ...
        def test_single_click(self, chrome_browser):
            web_buttons_page = WebButtonsPage(chrome_browser)
            web_buttons_page.open_page_buttons()
    ...
    class TestMock:
        ...
        def test_double_click_with_mock(self, chrome_browser):
            web_buttons_page = WebButtonsPage(chrome_browser)
            web_buttons_page.open_page_buttons()
        ...
        def test_right_click_with_mock(self, chrome_browser):
            web_buttons_page = WebButtonsPage(chrome_browser)
            web_buttons_page.open_page_buttons()
            # using mock for button as well
        ...
        def test_single_click_with_mock(self, chrome_browser):
            web_buttons_page = WebButtonsPage(chrome_browser)
            web_buttons_page.open_page_buttons()
            # using mock for button as well
    ...
    # class TestLinksPage:
    #
    #     def test_check_link(self, chrome_browser):
    #         web_links_page = LinksPage(chrome_browser)
    #         web_links_page.open_page_links()
    #         pass
    #
    #     def test_broken_link(self, chrome_browser):
    #         web_links_page = LinksPage(chrome_browser)
    #         web_links_page.open_page_links()
    #         pass
